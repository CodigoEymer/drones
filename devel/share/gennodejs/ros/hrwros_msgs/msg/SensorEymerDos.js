...
class SensorEymerDos {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SensorEymerDos(null);
  ...
  static datatype() {
    ...
    return 'hrwros_msgs/SensorEymerDos';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SensorEymerDos(null);
