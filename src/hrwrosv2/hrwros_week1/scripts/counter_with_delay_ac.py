...
from hrwros_msgs.msg import CounterWithDelayAction, CounterWithDelayGoal, CounterWithDelayResult, CounterWithDelayFeedback
...
def counter_with_delay_client():
    ...
    return client.get_feedback()  # A CounterWithDelayResult
...
if __name__ == '__main__':
	...
	rospy.loginfo(result.counts_elapsed)
