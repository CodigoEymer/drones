...
def PositionCallback(PositionCallback):
    global a
    global b
    global c
    a= PositionCallback.pose.pose.position.x
    b= PositionCallback.pose.pose.position.y
    c= PositionCallback.pose.pose.position.z
...
def menu():
    ...
    print "8: print cartesian coordinates"
...
if __name__ == '__main__':
    ...
    rospy.Subscriber("/mavros/global_position/local", Odometry, PositionCallback)
